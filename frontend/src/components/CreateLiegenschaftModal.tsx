...
const CreateLiegenschaftModal: React.FC<CreateLiegenschaftModalProps> = ({ onClose, onSuccess }) => {
    ...
    },
    {
      ...
      onError: (error: any) => {
        if (error.response?.data?.errors) {
          ...
          alert(error.response?.data?.message || 'Fehler beim Erstellen der Liegenschaft');
        }
      }
    }
  );
...
export default CreateLiegenschaftModal;