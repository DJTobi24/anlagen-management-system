...
export function DropdownItem({
  ...
  href?: string
  onClick?: () => void
} & Omit<React.ComponentPropsWithoutRef<'button'>, 'className' | 'onClick'>) {
  let classes = clsx(
    className,
    // Base styles
  ...
  return href ? (
    <Headless.MenuItem>
      {(itemProps: any) => (
        <Link to={href} {...itemProps} className={classes} {...props} />
      )}
    </Headless.MenuItem>
  ) : (
    <Headless.MenuItem>
      {(itemProps: any) => (
        <button type="button" onClick={onClick} {...itemProps} className={classes} {...props} />
      )}
    </Headless.MenuItem>
  )
}
